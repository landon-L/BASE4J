...
public abstract class BaseController {
	...
	protected ResponseEntity<ModelMap> setModelMap(ModelMap modelMap, HttpCode code, Object data) {
		...
		//putAll操作会复制一份对象，所以后面可以执行clear操作
		map.putAll(modelMap);
		modelMap.clear();
		// TODO: 2017/6/19   登陆时候modelMap中存储内容为 ？？？？？
		//{org.springframework.validation.BindingResult.login=org.springframework.validation.BeanPropertyBindingResult: 0 errors}
